...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderToggleUI.Position = UDim2.new(0.120833337, 1280, 0.0952890813, 545)
        ThunderToggleUI.Size = UDim2.new(0, 70, 0, 70)
        ...
        ThunderImageUI.Size = UDim2.new(0, 70, 0, 70)
...
function Update:Window(text,logo,keybind)
	...
	Main.AnchorPoint = Vector2.new(150,150)
	Main.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
	Main.Position = UDim2.new(0.5, 623, 0.5, 535)
	Main.Size = UDim2.new(0, 0, 0, 0)
	
	Main:TweenSize(UDim2.new(0, 520, 0, 330),"Out","Quad",0.1,true)
...
Logo.Image = "rbxassetid://12511245920"
	...
	ver1.Text = "Chúc bạn chơi game vui vẻ"
...
Ping.Parent.Text = ("[Ping] : " ..game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString(math.round(2/ping)))
   ...
   UserImageCorner.CornerRadius = UDim.new(0, 100)
	...
	timecock.Text = "N/Q"
	timecock.TextColor3 = Color3.fromRGB(181, 132, 255)
    ...
    function setTime()
        ...
        timecock.Text = ("Online: "..Hour.."  : "..Minute.."  : "..Second)
    end
 ...
 TabButton.Text = text
 TabButton.BackgroundColor3 = Color3.fromRGB(244,244,244)
 TabButton.BackgroundTransparency = 1.000
 TabButton.Size = UDim2.new(0, 125, 0, 23)
 TabButton.Font = Enum.Font.GothamSemibold
 TabButton.TextColor3 = Color3.fromRGB(225, 255, 255)
...
local postog = Instance.new("UIStroke")
 ...
 MainFramePage.ScrollBarThickness = 11
...
local postog12 = Instance.new("UIStroke")
 ...
 Space.TextColor3 = Color3.fromRGB(255,0,255)
 ...
 ImageButton.MouseButton1Click:Connect(function()
  ...
  game.TweenService:Create(ImageButton, TweenInfo.new(0.4, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
   {
    ImageColor3 = Color3.fromRGB(255,0,255)}
  ):Play()
  ImageButton.ImageRectOffset = Vector2.new(4, 836)
...
function main:Dropdown(text,option,callback)
 ...
 Item.MouseButton1Click:Connect(function()
  isdropping = false
  Dropdown:TweenSize(UDim2.new(0,370,0,31),"Out","Quad",0.2,true)
  TweenService:Create(
   DropImage,
   TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
   {
 ...
 DropButton.MouseButton1Click:Connect(function()
  ...
  isdropping = true
  Dropdown:TweenSize(UDim2.new(0,370,0,131),"Out","Quad",0.2,true)
  TweenService:Create(
   DropImage,
   TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
   {
...
function main:Seperator(text)
 ...
 Linee.Size = UDim2.new(0, 520, 0, 20)
...
function CheckBossQuest()
    ...
    elseif _G.Select_Boss == "Magma Admiral [Lv. 350] [Boss]" then
        ...
        LevelQuestBoss = 3
        CFrameQuestBoss = CFrame.new(-5317.07666, 12.2721891, 8517.41699, 0.51175487, -2.65508806e-08, -0.859131520, -3.91131572e-08, 1, -5.42026761e-08, 0.859131520, 6.13418294e-08, 0.51175487)
...
--------------------------------------------------------------------
local Library = Update:Window("Dulcie","")
...
local Weapon = Library:Tab("Nhiệm vụ","rbxassetid://11446859498")
...
local Race = Library:Tab("V4-Race","rbxassetid://11446900930")
...
local SelectWeapona = Setting:Dropdown("⚔ Weapon ⚔",WeaponList,function(value)
...
_G.DistanceMob = 20
Setting:Slider("Khoảng cách đến quái khi farm (P/s: 38 )",1,100,20,function(value)
 _G.DistanceMob = value
 end)
else
 _G.DistanceMob = 20
Setting:Slider1("Khoảng cách đến quái khi farm (P/s: 38 )",1,100,20,function(value)
 _G.DistanceMob = value
 end)
end


Setting:Toggle("Auto Set Points",false,function(value)
        ...
        if _G.FastAttack then
            if typeof(xShadowx) == "table" then
                pcall(function()
                    ...
                    xShadowx.activeController.humanoid.AutoRotate = false
                end)
            end
        end
    end)
...
Setting:Toggle("Disabled Damage Text",true,function(value)
...
if game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Respawn") then
    ...
    Setting:Button("FPS Boost Super",function()
        pcall(function()
...
Main:Dropdown("Select Mode Farm", {
 "Level Farm","Near Farm Mode","Fast Mode","No Quest"
},function(value)
...
Main:Toggle("Auto Quest Boss",false,function(value)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					Elite_Hunter_Status:Set("Status : Spawn ✅✅✅")	
				else
...
MaterialMethod = {
 ...
 local SelectMaterial = Weapon:Dropdown("Select Material",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Weapon:Toggle("Farm Selected Material",_G.AutoFarmMaterial,function(t)
...
Weapon:Toggle("Farm Ectoplasm - Vật chất kì dị",_G.Auto_Farm_Ectoplasm,function(value)
...
Weapon:Seperator(" \\ 🦴🦴🦴 Bone SEA 3 🦴🦴🦴 // ")

Weapon:Toggle("Auto Farm Bone 🦴🦴🦴",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 StopTween(_G.Auto_Farm_Bone)
 end)

Weapon:Toggle("Auto Trade Bone 🦴🦴🦴",_G.Auto_Trade_Bone,function(value)
...
Weapon:Button("Check Bone", function()
...
Weapon:Toggle("Auto Cake Prince",_G.CakePrince,function(value)
 _G.CakePrince = value
StopTween(_G.CakePrince)
end)
...
StopTween(_G.Auto_Open_Dough_Dungeon)
	...
	spawn(function()
		game:GetService("RunService").Heartbeat:Connect(function()
			pcall(function()
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.CakePrince and StartCakeStartMagnet and (v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 350 then
						v.HumanoidRootPart.CFrame = POSCAKE
						v.HumanoidRootPart.CanCollide = false
						v.HumanoidRootPart.Size = Vector3.new(50,50,50)
						if v.Humanoid:FindFirstChild("Animator") then
                                ...
                                if game.Workspace.Map.Desert.Burn.Part.CanCollide == false then
                                    ...
                                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Torch") or game.Players.LocalPlayer.Character:FindFirstChild("Torch") then
                                        ...
                                        if (CFrame.new(-1610.00757, 11.5049858, 164.001587).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
                                            ...
                                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1610.00757, 11.5049858, 164.001587, 0.984807551, -0.167722285, -0.0449818149, 0.17364943, 0.951244235, 0.254912198, 3.42372805e-05, -0.258850520, 0.965917408)
                                        end
                                    end
                                end
                            else
...
--------------------------------------------------------------Teleport------------------------------------------------
 ...
 Teleport:Button("Stop Teleport",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)
 ...
 Teleport:Button("Teleport To Sea 1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 Teleport:Button("Teleport To Sea 2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 Teleport:Button("Teleport To Sea 3",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)

if World2 then

 Teleport:Seperator("\\ TP Flower //")
		Teleport:Button("TP Flower Red",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
		...
		Teleport:Button("TP Flower Blue",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
...
---------------------------------------------------------RAID------------------------------------------------------
 ...
 Dungeon:Button("Stop Teleport",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)
...
----------------------------------------------------Fruit+ESP--------------------------------------------------------
  ...
  DevilFruit:Seperator(" Fruit ")

 DevilFruit:Toggle("Auto Random Fruit",true,function(value)
 ...
 DevilFruit:Toggle("Grab Fruit",false,function(value)
 _G.Grabfruit = value
end)
...
spawn(function()
 ...
 DevilFruit:Seperator(" ESP ")
				...
				if not isnil(v.Character) then
					if ESPPlayer then
						if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
							...
							bill.ExtentsOffset = Vector3.new(0, -12, 0)
							bill.Size = UDim2.new(1,200,1,10)
							...
							if v.Team == game.Players.LocalPlayer.Team then
								...
								name.TextColor3 = Color3.new(255,137,0)
							end
						else
						...
						if v.Character.Head:FindFirstChild('NameEsp'..Number) then
							v.Character.Head:FindFirstChild('NameEsp'..Number):Destroy(1)
						end
					end
				end
			end)
	...
	DevilFruit:Toggle("ESP Island",false,function(a)
		IslandESP = a
...
Shop:Seperator(" \\ Enchancement Colour // ")

    Shop:Toggle("Auto Enchancement Colour",true,function(value)
...
Shop:Toggle("Auto Buy Legendary Sword",_G.AutoBuyLegendarySword,function(Value)
		...
		Shop:Toggle("Auto Buy Legendary Sword Hop",_G.AutoBuySwordHop,function(Value)
...
Misc:Toggle("Dodge No Cooldown",true,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    ...
    Misc:Toggle("Infinite Soru",true,function(value)
    ...
    if World2 then
		Misc:Button("Xóa Dung Nham",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Lava" then   
					v:Destroy()
				end
...
Op:Seperator("\\  Team  //")
 Op:Button("Pirates Team",function()
 		local args = {
			[1] = "SetTeam",
			[2] = "Pirates"
		}
...
Op:Button("Marines Team",function()
 local args = {
			[1] = "SetTeam",
			[2] = "Marines"
		}
...
Op:Button("Rejoin",function()
 local ts = game:GetService("TeleportService")
		local p = game:GetService("Players").LocalPlayer
		ts:Teleport(game.PlaceId, p)
end)

Op:Button("Sever Hop",function()
 hop()
end)
    Op:Button("Hop To Lower Player",function()
